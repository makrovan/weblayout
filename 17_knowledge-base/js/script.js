...
function init() {
  ...
  ymaps.geocode('Франция, Иль-де-Франс, Париж, X округ Парижа, улица дю Фобур Сен Дени, 54', {
    /**
     * Опции запроса
...
validation
  .addField('#name', [
    ...
    },
    {
      rule: 'minLength',
      value: 3,
      errorMessage: 'Имя должно быть длиннее 3-х символов',
    },
    {
      rule: 'maxLength',
      value: 30,
      errorMessage: 'Имя должно быть короче 30-ти символов',
    },
  ])
  .addField('#email', [
    {
